  ...
  return (
      ...
      <div className="w-full max-w-6xl rounded bg-white shadow-xl p-10 lg:p-20 mx-auto text-gray-800 relative md:text-left">
          <div className="md:flex items-center -mx-10">
              <div className="w-[400px] md:w-1/2 px-10 mb-10 md:mb-0 h-[300px]">
                  <div className="relative  rounded-xl p-2">
                      <img src={image} className="w-[400px] h-[300px]   relative z-10 rounded-xl" alt=""/>
                ...
                <div className="w-full md:w-1/2 px-8">
                  ...
                  <div>
                      <div className="inline-block align-bottom">
                          <button className="bg-blue-500 opacity-75 hover:opacity-100 text-[#ffffff] rounded-full px-10 py-2 font-bold z-50" onClick={handlecheck}><i className="mdi mdi-cart -ml-2 mr-2" ></i>check-up</button>
                      </div>
                  </div>
                </div>
          </div>
